...
namespace LuaBehaviourTree
{
    ...
    public class SetShareString : BaseAction
    {
        ...
        public SetShareString(BTNode node, TBehaviourTree btowner, BTNode parentnode, int instanceid) : base(node, btowner, parentnode, instanceid)
        {
