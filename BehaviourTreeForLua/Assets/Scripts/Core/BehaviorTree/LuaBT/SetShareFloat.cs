...
namespace LuaBehaviourTree
{
    ...
    public class SetShareFloat : BaseAction
    {
        ...
        public SetShareFloat(BTNode node, TBehaviourTree btowner, BTNode parentnode, int instanceid) : base(node, btowner, parentnode, instanceid)
        {
