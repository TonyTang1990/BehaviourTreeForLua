/*
 * Description:             BTCompareShareInt.cs
 * Author:                  TONYTANG
...
{
    /// <summary>
    /// BTCompareShareInt.cs
    /// 比较自定义Int变量条件节点
    /// </summary>
    public class BTCompareShareInt : BTBaseConditionNode
    {
        /// <summary>
        /// 需要改变的自定义变量名
        /// </summary>
        ...
        #region 运行时部分
        public BTCompareShareInt(BTNode node, TBehaviourTree btowner, BTNode parentnode, int instanceid) : base(node, btowner, parentnode, instanceid)
        {
