...
namespace LuaBehaviourTree
{
    ...
    public class SetShareBool : BaseAction
    {
        ...
        public SetShareBool(BTNode node, TBehaviourTree btowner, BTNode parentnode, int instanceid) : base(node, btowner, parentnode, instanceid)
        {
