/*
 * Description:             CompareShareFloat.cs
 * Author:                  TONYTANG
...
namespace LuaBehaviourTree
{
    ...
    public class CompareShareFloat : BaseCondition
    {
        ...
        public CompareShareFloat(BTNode node, TBehaviourTree btowner, BTNode parentnode, int instanceid) : base(node, btowner, parentnode, instanceid)
        {
