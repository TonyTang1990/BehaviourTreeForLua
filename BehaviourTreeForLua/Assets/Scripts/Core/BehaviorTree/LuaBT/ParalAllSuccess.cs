/*
 * Description:             ParalAllSuccess.cs
 * Author:                  TANGHUAN
...
namespace LuaBehaviourTree
{
    ...
    public class ParalAllSuccess : BaseParal
    {
        ...
        public ParalAllSuccess(BTNode node, TBehaviourTree btowner, BTNode parentnode, int instanceid) : base(node, btowner, parentnode, instanceid)
        {
            OnCreate();
        }
