/*
 * Description:             CompareShareInt.cs
 * Author:                  TONYTANG
...
namespace LuaBehaviourTree
{
    ...
    public class CompareShareInt : BaseCondition
    {
        ...
        public CompareShareInt(BTNode node, TBehaviourTree btowner, BTNode parentnode, int instanceid) : base(node, btowner, parentnode, instanceid)
        {
